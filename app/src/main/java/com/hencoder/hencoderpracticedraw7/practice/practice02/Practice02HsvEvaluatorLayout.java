...
public class Practice02HsvEvaluatorLayout extends RelativeLayout {
    ...
    private class HsvEvaluator implements TypeEvaluator<Integer> {
        ...
        private float[] hsvStart = new float[3];
        private float[] hsvEnd = new float[3];
        ...
        public Integer evaluate(float fraction, Integer startValue, Integer endValue) {
            ...
            hsvStart[0] = hsvStart[0] + (hsvEnd[0] - hsvStart[0]) * fraction;
            hsvStart[1] = hsvStart[1] + (hsvEnd[1] - hsvStart[1]) * fraction;
            hsvStart[2] = hsvStart[2] + (hsvEnd[2] - hsvStart[1]) * fraction;

            return Color.HSVToColor(hsvStart);
        }
    }
}
